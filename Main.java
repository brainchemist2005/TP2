...
public class Main {
  ...
  public static String cryptage() {
    ...
    while (status != 1) {
      System.out.print("Cle DE CRYPTAGE : ");
      ...
      if (status == 0) {
        System.out.println("\nERREUR, cle invalide ! Recommencez...");
      }

    }
    System.out.print("MESSAGE A CRYPTER (ENTREE pour annuler) : ");
  ...
  public static String decryptage() {
    ...
    System.out.println("MESSAGE A DECRYPTER (ENTREE pour annuler) :");
    Message = Clavier.lireString();
